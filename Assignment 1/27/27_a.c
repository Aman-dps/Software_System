...
int main() {
    ...
    // Full path to ls (use "which ls" to confirm path)
...
-rw-r--r--@ 1 amantiwari  admin    669 Sep  6 11:04 27_a.c
-rw-r--r--  1 amantiwari  admin      0 Sep  6 10:41 27_b.c
-rw-r--r--  1 amantiwari  admin      0 Sep  6 10:41 27_c.c
...
-rwxr-xr-x  1 amantiwari  admin  33512 Sep  6 11:04 a.out
